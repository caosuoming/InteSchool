...
export const COLLECTIONS = [
  ...
  "studentInteractions", "studentInteractionFollows", "studentArchiveRecords", "schoolBackups", "platformResourceSettings", "platformResourceCorrections", "schoolAdminApplications",
