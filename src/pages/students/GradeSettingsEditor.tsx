import { Calculator, Check, SlidersHorizontal, Table2, UsersRound } from "lucide-react";
import type {
  GradeExamSettings,
  GradeImportContext,
    ...
    <Card className="p-0 overflow-hidden">
      <div className="flex items-start gap-3 border-b border-ink-100 px-5 py-4">
        ...
        <div>
          ...
          <div className="mt-0.5 text-xs text-ink-500">模板决定查询和导出时生成哪些在线表格，可调整分值口径、科目和分段算法。</div>
        </div>
      </div>
            ...
            <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  />
                  <div className="mt-1 text-xs text-ink-400">{item.kind}</div>
                </div>
              </div>
