...
export function GradeElectiveScoreSegmentTable({
  ...
  const exportReport = async () => {
    ...
    try {
      ...
      await exportGradeElectiveScoreSegmentReport(report, exam.name);
              ...
              <table className="w-max min-w-full table-auto border-collapse text-[11px]">
                <thead>
                  <tr className="bg-ink-50 text-ink-700">
                    ...
                    <th className="whitespace-nowrap border border-ink-300 px-2 py-1.5 text-center font-semibold">实际考试人数</th>
